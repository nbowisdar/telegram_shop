...
choose_goods_type = ReplyKeyboardMarkup(
    keyboard=[
...
def delete_or_update_one(id: int) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="♻️ Оновити", callback_data=f"change_one|update|{id}"
                ),
                InlineKeyboardButton(
                    text="🗑 Видалити", callback_data=f"change_one|delete|{id}"
                ),
            ],
            [admin_drop_msg],
        ]
...
def update_goods_inl(goods: GoodsModel) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=status, callback_data=f"change_goods_active|{goods.id}"
                )
            ],
            [
                InlineKeyboardButton(
            ...
            [
                ...
                InlineKeyboardButton(
                    text=f"🖌 Тип", callback_data="update_goods_field|is_in_box"
                ),
            ],
            [
                InlineKeyboardButton(
...
def other_bot_btn() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[
            [
                KeyboardButton(text=action_with_bot),
                KeyboardButton(text=action_with_card),
            ],
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    ...
                    callback_data=f"found_user|last_10_order|{user_id}",
                ),
                InlineKeyboardButton(
                    text=text, callback_data=f"found_user|{action}|{user_id}"
                ),
            ],
            [
                InlineKeyboardButton(
